      ...
      <div className="max-w-7xl mx-auto">
          ...
          <div className="flex items-center justify-between">
            <div>
              <h1 className="text-3xl font-bold text-gray-800 flex items-center gap-3">
                ...
                Concrete Quality Prediction System
              </h1>
              <p className="text-gray-600 mt-2">Interactive Mix Design & Strength Prediction Dashboard</p>
            </div>
            <div className="text-right">
              <div className="text-sm text-gray-500">Model: XGBoost v1.0</div>
          ...
          <div className="bg-gradient-to-r from-blue-500 to-blue-600 rounded-xl shadow-xl p-8 mb-6 text-white">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="text-center">
                <div className="text-sm opacity-90 mb-2">Predicted Compressive Strength</div>
              ...
              <div className="text-center border-l border-r border-blue-400 px-4">
                <div className="text-sm opacity-90 mb-2">Quality Classification</div>
              ...
              <div className="text-center">
                <div className="text-sm opacity-90 mb-2">Water-Cement Ratio</div>
        ...
        {loading && (
          <div className="bg-blue-500 rounded-xl shadow-xl p-8 mb-6 text-white text-center">
            <div className="text-2xl">⏳ Calculating prediction...</div>
          </div>
        )}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6">
          ...
          <div className="bg-white rounded-xl shadow-lg p-6">
            <h2 className="text-xl font-bold text-gray-800 mb-4">Mix Composition Analysis</h2>
            ...
            <div className="mt-4 text-sm text-gray-600 text-center">
              Balanced mix design across key parameters
            </div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <div className="bg-white rounded-xl shadow-lg p-6">
            <h2 className="text-xl font-bold text-gray-800 mb-4">Water-Cement Ratio Impact</h2>
            <ResponsiveContainer width="100%" height={300}>
            ...
            <div className="mt-4 text-sm text-gray-600 text-center">
              Lower W/C ratio generally yields higher strength
            </div>
          </div>

          {/* Component Comparison */}
          <div className="bg-white rounded-xl shadow-lg p-6">
            <h2 className="text-xl font-bold text-gray-800 mb-4">Mix Components vs Optimal</h2>
            <ResponsiveContainer width="100%" height={300}>
          ...
          {/* Quick Stats */}
          <div className="bg-white rounded-xl shadow-lg p-6">
            <h2 className="text-xl font-bold text-gray-800 mb-4">Mix Statistics</h2>
            <div className="space-y-4">
              <div className="flex justify-between items-center p-3 bg-blue-50 rounded-lg">
                <span className="text-gray-700">Total Cementitious</span>
                <span className="font-bold text-blue-600">
                  {(mixParams.cement + mixParams.blast_furnace_slag + mixParams.fly_ash).toFixed(0)} kg/m³
                </span>
              </div>
              <div className="flex justify-between items-center p-3 bg-green-50 rounded-lg">
                <span className="text-gray-700">Total Aggregates</span>
                <span className="font-bold text-green-600">
                  {(mixParams.coarse_aggregate + mixParams.fine_aggregate).toFixed(0)} kg/m³
                </span>
              </div>
              <div className="flex justify-between items-center p-3 bg-purple-50 rounded-lg">
                <span className="text-gray-700">SCM Replacement</span>
              ...
              <div className="flex justify-between items-center p-3 bg-orange-50 rounded-lg">
                <span className="text-gray-700">Fine/Coarse Ratio</span>
        ...
        <div className="mt-6 text-center text-sm text-gray-600">
          <p>🇲🇦 Developed for Moroccan Construction Industry | Powered by Azure ML & XGBoost</p>
